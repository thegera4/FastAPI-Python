...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Gerardo\PycharmProjects\FastAPI-Python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Gerardo\PycharmProjects\FastAPI-Python\venv\Scripts\deactivate.nu'
